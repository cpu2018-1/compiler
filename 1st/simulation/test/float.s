...
lib_read_token:
	...
	beq	r1, r2, _beq_then.872
	addi	r2, r0, 10				# li	r2, 10
	beq	r1, r2, _beq_then.873
	addi	r2, r0, 26				# li	r2, 26
	beq	r1, r2, _beq_then.874
	addi	r30, r31, 0				#mflr	r30
	sw	r30, 1(r3)
	addi	r3, r3, 2
...
#	main program starts
	addi	r30, r0, 52429
	lui	r30, r30, 49476	# to load float		-12.300000
	fmvfr	f1, r30
	addi	r30, r31, 0				#mflr	r30
	sw	r30, 0(r3)
	addi	r3, r3, 1
