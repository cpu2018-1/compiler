...
lib_abs_float:
	...
	fmvfr	f2, r30
	fle	r30, f2, f1
	bne	r0, r30, _fle_then.720
 lib_fneg	f1, f1
	jr	r31				#	blr
_fle_then.720:
	jr	r31				#	blr
lib_fless:
	ble	r2, r1, _ble_then.721
	addi	r1, r0, 1				# li	r1, 1
	jr	r31				#	blr
_ble_then.721:
	addi	r1, r0, 0				# li	r1, 0
