...
ble_cont.521:
	...
	lui	r30, r30, 16524
	fmvfr	f3, r30
	ble	f3, f1, ble_then.522
	j	atan_body
ble_then.522:
	addi	r30, r0, 0	# to load float		2.437500
	lui	r30, r30, 16412
	fmvfr	f3, r30
	ble	f3, f1, ble_then.523
	addi	r30, r0, 0	# to load float		4.000000
	lui	r30, r30, 16512
	fmvfr	f3, r30
	addi	r30, r0, 4059	# to load float		0.785398
