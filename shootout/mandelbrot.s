...
iloop.58:
	...
	sw	r30, 16(r3)				#stfd	f3, 16(r3)
	fmvtr	r30, f6
	sw	r30, 24(r3)				#stfd	f6, 24(r3)
	fmvtr	r30, f2
	sw	r30, 32(r3)				#stfd	f2, 32(r3)
	addi	r30, r31, 0				#mflr	r30
	sw	r30, 44(r3)
	addi	r3, r3, 48
	jal	dbl.41				#	bl	dbl.41
	addi	r30, r0, 48
	sub	r3, r3, r30
	lw	r30, 44(r3)
	add	r31, r0, r30				#mtlr	r30
...
xloop.48:
	...
	lw	r30, 12(r3)
	add	r31, r0, r30				#mtlr	r30
	addi	r30, r0, 0	# to load float		100.000000
	lui	r30, r30, 17096
	fmvfr	f2, r30
	fdiv	f1, f1, f2
	addi	r30, r0, 0	# to load float		1.500000
	lui	r30, r30, 16320
	fmvfr	f2, r30
	fsub	f1, f1, f2
	lw	r1, 4(r3)
