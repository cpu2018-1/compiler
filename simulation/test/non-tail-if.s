...
# initialize buf
  ...
  addi  r4, r4, 17
#	main program starts
	addi	r30, r0, 28836	# to load float		1.230000
	lui	r30, r30, 16285
	fmvfr	f1, r30
	addi	r30, r31, 0				#mflr	r30
	sw	r30, 0(r3)
	...
	lw	r30, 0(r3)
	add	r31, r0, r30				#mtlr	r30
	addi	r30, r0, 60293	# to load float		4.560000
	lui	r30, r30, 16529
	fmvfr	f1, r30
	sw	r1, 0(r3)
	addi	r30, r31, 0				#mflr	r30
	...
	lw	r30, 1(r3)
	add	r31, r0, r30				#mtlr	r30
	addi	r30, r0, 31457	# to load float		-7.890000
	lui	r30, r30, 49404
	fmvfr	f1, r30
	sw	r1, 1(r3)
	addi	r30, r31, 0				#mflr	r30
