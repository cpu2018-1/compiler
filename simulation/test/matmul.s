...
loop1.269:
	...
	lw	r8, 1(r28)
	addi	r9, r0, 0				# li	r9, 0
	ble	r9, r1, ble_then.399
	jr	r31				#	blr
ble_then.399:
	add	r9, r0, r4				# mr	r9, r4
	addi	r4, r4, 6
	addi	r10, r0, loop2.274
	sw	r10, 0(r9)
	sw	r5, 5(r9)
	sw	r1, 4(r9)
	sw	r6, 3(r9)
