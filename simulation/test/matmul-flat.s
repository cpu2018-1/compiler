...
#	main program starts
	...
	sw	r30, 1(r1)
	lw	r1, 0(r6)
	addi	r30, r0, 0	# to load float		3.000000
	lui	r30, r30, 16448
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 2(r1)
	...
	sw	r30, 0(r1)
	lw	r1, 1(r6)
	addi	r30, r0, 0	# to load float		5.000000
	lui	r30, r30, 16544
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 1(r1)
	lw	r1, 1(r6)
	addi	r30, r0, 0	# to load float		6.000000
	lui	r30, r30, 16576
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 2(r1)
	lw	r7, 2(r3)
	lw	r1, 0(r7)
	addi	r30, r0, 0	# to load float		7.000000
	lui	r30, r30, 16608
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 0(r1)
	lw	r1, 0(r7)
	addi	r30, r0, 0	# to load float		8.000000
	lui	r30, r30, 16640
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 1(r1)
	lw	r1, 1(r7)
	addi	r30, r0, 0	# to load float		9.000000
	lui	r30, r30, 16656
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 0(r1)
	...
	sw	r30, 1(r1)
	lw	r1, 2(r7)
	addi	r30, r0, 0	# to load float		11.000000
	lui	r30, r30, 16688
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 0(r1)
	lw	r1, 2(r7)
	addi	r30, r0, 0	# to load float		12.000000
	lui	r30, r30, 16704
	fmvfr	f1, r30
	fmvtr	r30, f1
	sw	r30, 1(r1)
