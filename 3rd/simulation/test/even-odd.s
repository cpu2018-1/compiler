...
# library ends
odd.21:
	bgei	r1, 0, bge_then.36
	addi	r1, r1, -1
	j	even.17
bge_then.36:
	addi	r2, r0, 0				# li	r2, 0
	ble	r2, r1, ble_then.37
	addi	r1, r1, 1
	j	even.17
ble_then.37:
	addi	r1, r0, 456				# li	r1, 456
	jr	r31				#	blr
even.17:
	bgei	r1, 0, bge_then.38
	addi	r1, r1, -1
	j	odd.21
bge_then.38:
	addi	r2, r0, 0				# li	r2, 0
	ble	r2, r1, ble_then.39
	addi	r1, r1, 1
	j	odd.21
ble_then.39:
	addi	r1, r0, 123				# li	r1, 123
	jr	r31				#	blr
_R_0:
