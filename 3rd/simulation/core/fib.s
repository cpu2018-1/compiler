...
lib_read_token:
	...
	beqi	9, r1, _beq_then.920
	beqi	13, r1, _beq_then.921
	beqi	10, r1, _beq_then.922
	addi	r2, r0, 26				# li	r2, 26
	beq	r1, r2, _beq_then.923
	sw	r31, 1(r3)
	addi	r3, r3, 2
