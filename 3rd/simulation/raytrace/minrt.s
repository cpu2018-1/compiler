...
solver_fast.3073:
	...
	lw	r1, 0(r30)
	lw	r6, 1(r5)
	beqi	1, r6, beq_then.16065
	beqi	2, r6, beq_then.16066
	add	r2, r0, r1
	add	r1, r0, r5
...
solver_fast2.3091:
	...
	lw	r1, 0(r30)
	lw	r6, 1(r5)
	beqi	1, r6, beq_then.16081
	beqi	2, r6, beq_then.16082
	add	r2, r0, r1
	add	r1, r0, r5
	add	r5, r0, r7
...
is_outside.3128:
	...
	flw	f4, 2(r6)
	fsub	f3, f3, f4
	beqi	1, r7, beq_then.16188
	beqi	2, r7, beq_then.16189
	sw	r1, 0(r3)
	sw	r31, 1(r3)
	addi	r3, r3, 2
	jal	quadratic.3031				
...
trace_or_matrix_fast.3170:
	...
	lw	r9, 1(r8)
	sw	r6, 3(r3)
	beqi	1, r9, beq_then.16449
	beqi	2, r9, beq_then.16451
	add	r5, r0, r10
	add	r2, r0, r7
	add	r1, r0, r8
	sw	r31, 4(r3)
...
utexture.3185:
	...
	flw	f1, 2(r5)
	fsw	f1, 736(r0)
	beqi	1, r6, beq_then.16532
	beqi	2, r6, beq_then.16533
	beqi	3, r6, beq_then.16534
	beqi	4, r6, beq_then.16535
	jr	r31				#
beq_then.16535:
	flw	f1, 0(r2)
	lw	r5, 5(r1)
...
fle_cont.16651:
	...
	lw	r2, 1(r1)
	sw	r1, 3(r3)
	beqi	1, r2, beq_then.16655
	beqi	2, r2, beq_then.16657
	sw	r31, 4(r3)
	addi	r3, r3, 5
	jal	get_nvector_second.3180				
	addi	r3, r3, -5
...
beq_cont.16735:
	...
	lw	r6, 3(r3)
	addi	r7, r6, 1
	blei	4, r7, ble_then.16736
	jr	r31				#
ble_then.16736:
	lw	r6, 2(r2)
	add	r30, r6, r7
	lw	r6, 0(r30)
	bgei	0, r6, bge_then.16738
	jr	r31				#
bge_then.16738:
	add	r30, r5, r1
	lw	r6, 0(r30)
...
beq_cont.16743:
beq_cont.16741:
	beqi	0, r6, beq_then.16748
	lw	r2, 3(r2)
	add	r30, r2, r7
	lw	r2, 0(r30)
	sw	r7, 6(r3)
	beqi	0, r2, beq_then.16749
	lw	r6, 1(r3)
	add	r2, r0, r8
	sw	r31, 7(r3)
	addi	r3, r3, 8
...
write_rgb.3255:
	...
	addi	r1, r0, 255
	ftoi	r2, f1
	ble	r2, r1, ble_then.16761
	addi	r1, r0, 255
	j	ble_cont.16762
ble_then.16761:
	bgei	0, r2, bge_then.16763
	addi	r1, r0, 0
	j	bge_cont.16764
bge_then.16763:
	add	r1, r0, r2
...
ble_cont.16762:
	...
	addi	r1, r0, 255
	ftoi	r2, f1
	ble	r2, r1, ble_then.16765
	addi	r1, r0, 255
	j	ble_cont.16766
ble_then.16765:
	bgei	0, r2, bge_then.16767
	addi	r1, r0, 0
	j	bge_cont.16768
bge_then.16767:
	add	r1, r0, r2
...
ble_cont.16766:
	...
	addi	r1, r0, 255
	ftoi	r2, f1
	ble	r2, r1, ble_then.16769
	addi	r1, r0, 255
	j	ble_cont.16770
ble_then.16769:
	bgei	0, r2, bge_then.16771
	addi	r1, r0, 0
	j	bge_cont.16772
bge_then.16771:
	add	r1, r0, r2
...
beq_cont.16793:
	...
	addi	r1, r0, 255
	ftoi	r2, f1
	ble	r2, r1, ble_then.16812
	addi	r1, r0, 255
	j	ble_cont.16813
ble_then.16812:
	bgei	0, r2, bge_then.16814
	addi	r1, r0, 0
	j	bge_cont.16815
bge_then.16814:
	add	r1, r0, r2
...
ble_cont.16813:
	...
	addi	r1, r0, 255
	ftoi	r2, f1
	ble	r2, r1, ble_then.16816
	addi	r1, r0, 255
	j	ble_cont.16817
ble_then.16816:
	bgei	0, r2, bge_then.16818
	addi	r1, r0, 0
	j	bge_cont.16819
bge_then.16818:
	add	r1, r0, r2
...
ble_cont.16817:
	...
	addi	r1, r0, 255
	ftoi	r2, f1
	ble	r2, r1, ble_then.16820
	addi	r1, r0, 255
	j	ble_cont.16821
ble_then.16820:
	bgei	0, r2, bge_then.16822
	addi	r1, r0, 0
	j	bge_cont.16823
bge_then.16822:
	add	r1, r0, r2
...
ble_cont.16821:
	...
	lw	r5, 2(r3)
	addi	r7, r5, 1
	ble	r1, r7, ble_then.16825
	blei	0, r5, ble_then.16827
	lw	r1, 743(r0)
	addi	r7, r2, 1
	ble	r1, r7, ble_then.16829
	blei	0, r2, ble_then.16831
	addi	r1, r0, 1
	j	ble_cont.16832
ble_then.16831:
	addi	r1, r0, 0
...
ble_cont.16839:
	...
	lw	r5, 3(r3)
	addi	r7, r5, 1
	ble	r1, r7, ble_then.16842
	blei	0, r5, ble_then.16844
	lw	r1, 743(r0)
	blei	1, r1, ble_then.16846
	addi	r1, r0, 0
	j	ble_cont.16847
ble_then.16846:
	addi	r1, r0, 0
...
setup_surface_reflection.3338:
	...
	flw	f9, 669(r0)
	slli	r1, r1, 2
	flup	f10, 2		# fli	f10, 1.000000
	addi	r9, r0, 3
	flup	f11, 0		# fli	f11, 0.000000
	lw	r10, 1023(r0)
	addi	r1, r1, 1
	flw	f12, 0(r2)
	fsub	f10, f10, f12
...
bge_cont.17013:
	...
	fsw	f1, 2(r1)
	lw	r1, 0(r0)
	addi	r2, r0, 1021				# set min_caml_light_dirvec
	addi	r1, r1, -1
	add	r28, r0, r2
	add	r2, r0, r1
	add	r1, r0, r28
